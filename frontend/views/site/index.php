        ...
        <?php foreach ($lasteventos as $evento) { ?>
          <div class="u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-1">
              ...
              <h5 class="u-custom-font u-font-pt-sans u-text u-text-3" spellcheck="false">
                  <?php 
                      $dataEvento = date_create($evento->dataevento);
                      echo $dataEvento->format('F d, Y'); // Formato: Mês dia, Ano
                  ?>
              </h5>
            </div>
          </div>
