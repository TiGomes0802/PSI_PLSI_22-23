...
<div class="u-form u-form-1">    
    <?php $form = ActiveForm::begin(); ?>
        ...
        <div class="u-form-group u-form-name u-label-top">
            ...
            <?= $form->field($model, 'descricao')->input('text', ['placeholder' => 'Descrição'])->label(false); ?>
        </div>

        <div class="u-form-group u-form-name u-label-top">
            <label for="feito" class="u-label u-spacing-0 u-text-custom-color-1 u-label">Feito</label>
            <?= $form->field($model, 'feito')->dropdownList([ 'false' => 'Não Realizada', 'true' => 'Realizada'],['prompt'=>'Seleciona o feito'])->label(false); ?>
        </div>
